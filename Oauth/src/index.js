...
import "./strategies/discord-strategie.js";

const app = express();
const dburl = "Put your connection url of MongoDB";
mongoose
    .connect(dburl)
...
app.use(sessions({
    ...
    // this store the session data in MongoDB database 
...
app.get("/api/authenticate/discord", passport.authenticate('discord'))
app.get("/api/authenticate/discord/redirect", passport.authenticate('discord'), (req, res) => {
    console.log(req.session)
    console.log(req.user)
    res.sendStatus(200);
})
